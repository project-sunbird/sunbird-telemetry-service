...
public class EkstepTelemetryDispatcher {
	...
	private static Map<String, String> getHeaders(Map<String, String[]> headers) {
		return headers.entrySet().stream()
				.filter(x -> Arrays.asList("content-encoding", "accept-encoding", "content-type")
	...
	private static void executeRequest(BaseRequest request) throws Exception {
		...
		try {
			...
			throw new ProjectCommonException("TELEMETRY_DISPACHER_ERROR",
		...
		System.out.println("Response body:" + result.getBody().toString());
